...
- [Direct `.deb` download](https://github.com/bitflip55/EasyPhotoPrint/releases/download/v0.1.14/EasyPhotoPrint_0.1.14_amd64.deb)
...
```bash
wget "https://github.com/bitflip55/EasyPhotoPrint/releases/download/v0.1.14/EasyPhotoPrint_0.1.14_amd64.deb"
sudo apt install "./EasyPhotoPrint_0.1.14_amd64.deb"
```
