...
- [Direct `.deb` download](https://github.com/bitflip55/EasyPhotoPrint/releases/download/v0.2.0-beta.1/EasyPhotoPrint_0.2.0-beta.1_amd64.deb)
...
```bash
wget "https://github.com/bitflip55/EasyPhotoPrint/releases/download/v0.2.0-beta.1/EasyPhotoPrint_0.2.0-beta.1_amd64.deb"
sudo apt install "./EasyPhotoPrint_0.2.0-beta.1_amd64.deb"
```
