...
- [Direct `.deb` download](https://github.com/bitflip55/EasyPhotoPrint/releases/download/v0.1.1/Easy%20Photo%20Print_0.1.1_amd64.deb)
- [Direct `.rpm` download](https://github.com/bitflip55/EasyPhotoPrint/releases/download/v0.1.1/Easy%20Photo%20Print-0.1.1-1.x86_64.rpm)
...
```bash
wget "https://github.com/bitflip55/EasyPhotoPrint/releases/download/v0.1.1/Easy%20Photo%20Print_0.1.1_amd64.deb"
