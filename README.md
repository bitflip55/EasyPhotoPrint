...
- [Linux `.deb` download](https://github.com/bitflip55/EasyPhotoPrint/releases/download/v0.2.4/EasyPhotoPrint_0.2.4_amd64.deb)
- [Linux `.rpm` download](https://github.com/bitflip55/EasyPhotoPrint/releases/download/v0.2.4/EasyPhotoPrint-0.2.4-1.x86_64.rpm)
- [Windows `.msi` download](https://github.com/bitflip55/EasyPhotoPrint/releases/download/v0.2.4/EasyPhotoPrint_0.2.4_x64_en-US.msi)
- [macOS `.dmg` download](https://github.com/bitflip55/EasyPhotoPrint/releases/download/v0.2.4/EasyPhotoPrint_0.2.4_aarch64.dmg)
...
- [EasyPhotoPrint_0.2.4_amd64.deb](https://github.com/bitflip55/EasyPhotoPrint/releases/download/v0.2.4/EasyPhotoPrint_0.2.4_amd64.deb)

Install with `apt`:

```bash
wget "https://github.com/bitflip55/EasyPhotoPrint/releases/download/v0.2.4/EasyPhotoPrint_0.2.4_amd64.deb"
sudo apt install "./EasyPhotoPrint_0.2.4_amd64.deb"
```
...
- [EasyPhotoPrint-0.2.4-1.x86_64.rpm](https://github.com/bitflip55/EasyPhotoPrint/releases/download/v0.2.4/EasyPhotoPrint-0.2.4-1.x86_64.rpm)

Install with `dnf`:

```bash
wget "https://github.com/bitflip55/EasyPhotoPrint/releases/download/v0.2.4/EasyPhotoPrint-0.2.4-1.x86_64.rpm"
sudo dnf install "./EasyPhotoPrint-0.2.4-1.x86_64.rpm"
```
...
- [EasyPhotoPrint_0.2.4_x64_en-US.msi](https://github.com/bitflip55/EasyPhotoPrint/releases/download/v0.2.4/EasyPhotoPrint_0.2.4_x64_en-US.msi)
